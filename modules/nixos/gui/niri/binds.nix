    ...
    hm.wayland.windowManager.niri.settings.binds =
      {
        ...
        #
        "Mod+E".spawn = ["rofi" "-show" "emoji" "-theme" "${config.hm.xdg.configHome}/rofi/emoji.rasi"];
        "Mod+Q".spawn = ["rofi" "-show" "calc" "-theme" "${config.hm.xdg.configHome}/rofi/calc.rasi"];
        "Mod+Shift+W".spawn = ["rofi" "-show" "window" "-theme" "${config.hm.xdg.configHome}/rofi/window.rasi"];
